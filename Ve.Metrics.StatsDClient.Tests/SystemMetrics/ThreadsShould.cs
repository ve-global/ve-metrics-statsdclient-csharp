...
{
    [TestFixture]
    public class ThreadsShould
    {
        private Mock<IVeStatsDClient> _statsd;
        private Threads _metric;
        ...
        {
            _metric.Name.ShouldBe("Threads");
        }

        [Test]
        public void It_should_get_the_number_of_threads_and_log_it_to_statsd()
        {
            _statsd.Verify(x => x.LogGauge("process.threads", It.IsAny<int>(), It.IsAny<Dictionary<string, string>>()));
        }
    }
}
